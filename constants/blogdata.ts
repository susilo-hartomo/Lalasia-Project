...
export const BlogData: ArticleTypes[] = [
  ...
  },
  {
    ...
    author: 'Rizal Ahmad',
    avatar: '/avatar_small4.png',
    category: 'Color Guide',
    date: new Date(2022, 10, 2).toJSON(),
    thumbnail: '/article_slider.jpg',
    summary:
      'Home terrace decorations are part of every decoration or overall home design. Interiordesign.id – If by chance your house has enough space or space.',
    content: '',
  },
  ...
  },
  {
    ...
    author: 'Jane Doe',
    avatar: '/avatar_small2.png',
    category: 'Color Guide',
    date: new Date(2022, 11, 5).toJSON(),
    thumbnail: '/rectangle45.jpg',
    summary:
      'Home terrace decorations are part of every decoration or overall home design. Interiordesign.id – If by chance your house has enough space or space.',
    content: '',
  },
  {
    ...
    author: 'John Doe',
    avatar: '/avatar_small3.png',
    category: 'Tips and Trick',
    date: new Date(2022, 10, 3).toJSON(),
    thumbnail: '/article_slider2.jpg',
    summary:
      'Home terrace decorations are part of every decoration or overall home design. Interiordesign.id – If by chance your house has enough space or space.',
    content: '',
  },
