...
function ArticleCard({ img, category, title, prefix, iconProfil, name, date }) {
	return (
		<div className='flex flex-row gap-3 mb-7 justify-between items-center'>
			<div className='w-[450px] h-[260px]'>
				<Image src={img} alt={'imageArticle'} width={260} height={260} />
			</div>
			<div className='h-[205px]'>
				<p className='text-paragraph-1 mb-[21px]'>{category}</p>
				<h3 className='heading font-bold mb-[14px] hover:text-slate-500'>{title}</h3>
