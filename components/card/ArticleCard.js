	...
	return (
		<div className='w-[327px] h-[110px] lg:h-[260px] lg:w-full flex flex-row gap-3 lg:mb-7 mb-5 justify-between items-center'>
			...
			<div className='lg:h-[205px] lg:w-[329px] h-[106px] w-[203px]'>
				<p className='text-paragraph-1 lg:mb-[21px] mb-1 paragraph'>{category}</p>
				<h3 className='heading font-bold lg:mb-[14px] mb-3 hover:text-slate-500 truncate'>{title}</h3>
				<p className='text-paragraph-1 lg:mb-[16px] lg:block hidden'>{prefix}</p>
				<div className='lg:flex flex-row justify-between items-center'>
					...
					<div>
						<p className='text-paragraph-1 lg:block paragraph hidden'>{date}</p>
					</div>
				</div>
			</div>
		</div>
