    ...
    return (
        ...
        >
            ...
            <div className="">
                ...
                <h3
                    className={`font-bold text-title-1 ${responsiveStyle.nameStyle}`}
                >
                    {name}
                </h3>
                ...
                <h3
                    className={`heading text-title-1 ${responsiveStyle.priceStyle}`}
                >
                    {price}
                </h3>
            </div>
			...
			<div className='my-3'>
				...
				<h3
					className={`font-bold text-title-1 ${
						responsiveParent ? 'whitespace-nowrap truncate text-base my-3 lg:text-2xl' : 'mb-1'
					}`}>
					{name}
				</h3>
				<p className={`text-paragraph-1 ${responsiveParent ? 'whitespace-nowrap truncate my-3' : 'mb-4'}`}>
					{desc}
				</p>
