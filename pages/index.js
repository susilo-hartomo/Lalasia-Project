    ...
    return (
      <div className="container mx-auto relative">
        <h1 className="heading text-center lg:w-[724px] mx-auto lg:mt-[100px] mt-[50px] relative">
          ...
          <span className="sm:-mt-[20px] absolute mx-1 sm:mx-2 w-[24px] h-[24px] sm:w-[51px] sm:h-[51px]">
        ...
        <p className="text-center mx-auto  lg:w-[796px] paragraph par1 px-4 mt-[30px]">
