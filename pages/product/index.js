    ...
    return (
      <div className="my-24">
        <div class="dark:bg- mx-auto my-4 lg:w-[600px] px-4">
          ...
          <p class="text-center paragraph my-5">
    ...
    return (
      <div className="flex justify-center mt-24">
        ...
        >
          <a
            href="#"
            class="relative inline-flex items-center rounded-l-md px-2 py-2 text-sm font-medium text-gray-500 hover:bg-gray-50 focus:z-20"
          >
          ...
          <a
            href="#"
            aria-current="page"
            class="relative z-10 inline-flex items-center border bg-[#518581] px-4 py-2 text-sm font-medium text-white focus:z-20"
          >
            1
          </a>
          <a
